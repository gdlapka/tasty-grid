...
const TestGrid = () => {
  ...
  const [oldPerPage, setOldPerPage] = useState(defaultPerPage);
  const [indexRange, setIndexRange] = useState({ start: 0, end: 0 });
  ...
  return (
    <div className="main-container">
      ...
      <Pagination
        ...
        {...({ page, setPage, perPage, setPerPage, indexRange, setIndexRange })}
      />
    </div>
  );
};
